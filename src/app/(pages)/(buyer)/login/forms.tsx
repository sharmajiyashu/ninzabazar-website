    ...
    <div className="w-full flex flex-col">
      ...
      <div className="flex bg-white border border-gray-200 p-1.5 rounded-xl w-full mb-6">
        <button
          ...
          className={`flex-1 py-2 rounded-lg text-sm font-semibold transition-all duration-300 ${activeTab === 'email'
        ...
        <button
          ...
          className={`flex-1 py-2 rounded-lg text-sm font-semibold transition-all duration-300 ${activeTab === 'mobile'
            ? 'bg-[#006d44] text-white shadow-sm'
            : 'text-[#006d44] hover:bg-gray-50'
            }`}
        >
      ...
      <div className="flex items-center justify-between text-xs text-gray-500 mt-6 mb-4">
        ...
        <Link href="/login" className="text-[#006d44] font-semibold hover:underline">
          Forgot password?
        </Link>
      </div>
